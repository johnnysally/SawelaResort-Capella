...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className=" py-20 bg-gradient-to-br from-[#8B5E3C] via-[#F5F5DC] to-[#3A7D44]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="text-center mb-16">
          <Badge className="mb-4 bg-green-100 text-green-900 border-green-300">Contact Us</Badge>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-green-900 mb-6">Get in Touch</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label htmlFor="resort" className="block text-sm font-medium text-green-900 mb-2">
                        Preferred Resort
                      </label>
                      <select
                        id="resort"
                        ...
                        onChange={handleInputChange}
                        className="w-full px-3 py-2 border border-green-300 rounded-md bg-amber-50 text-green-900 focus:outline-none focus:ring-2 focus:ring-green-400"
                      >
                  ...
                  <Button
                    ...
                    className="w-full bg-green-200 hover:bg-green-300 text-green-900 py-3 hover-lift"
                  >
                    {isSubmitting ? (
                      <>
          ...
          <div className="space-y-6">
            ...
            {contactInfo.map((info, index) => (
              <Card
                key={index}
                className="luxury-shadow hover-lift border-0 bg-amber-100"
              >
                <CardContent className="p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-lg font-semibold text-green-900 mb-2">{info.title}</h4>
                      {info.details.map((detail, idx) => (
                        <p key={idx} className="text-green-900 font-medium">
                          {detail}
                        </p>
                      ))}
                      <p className="text-sm text-green-700 mt-2">{info.description}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
